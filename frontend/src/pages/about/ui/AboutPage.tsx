...
const TIMELINE = [
  { year: '2007', text: 'Основание компании Нексу в России. Первые поставки виниловых фасадных материалов.' },
  ...
  { year: '2021', text: 'Запуск обновлённой линейки Нексу LUX с расширенной цветовой палитрой (24 цвета).' },
...
export const AboutPage = () => (
  <>
    <Helmet>
      ...
      <meta name="description" content="История и ценности компании Нексу — производителя строительных материалов для фасадов и кровли." />
    </Helmet>
    ...
    <section style={{ background: 'var(--color-primary)', color: '#fff', padding: '60px 0' }}>
      <div className="container">
        ...
        <h1 style={{ fontSize: 42, fontWeight: 800, margin: '24px 0 12px' }}>О компании Нексу</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }}>
          <div>
            ...
            <p style={{ color: '#616161', lineHeight: 1.8, marginBottom: 16 }}>
              Нексу производит строительные материалы, которые делают дома красивее, теплее и долговечнее.
