...
const banners_controller_1 = require("./presentation/controllers/banners.controller");
let BannersModule = class BannersModule {
};
exports.BannersModule = BannersModule;
exports.BannersModule = BannersModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([banner_orm_entity_1.BannerOrmEntity]), auth_module_1.AuthModule],
        controllers: [banners_controller_1.BannersController],
        providers: [get_active_banners_use_case_1.GetActiveBannersUseCase],
    })
], BannersModule);
